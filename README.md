...
This project adds a graphical user interface to the original terminal-based whack a cat project, making it easier to use while keeping the same functionality.

Credits: Original project by GWCSS CS Club.
